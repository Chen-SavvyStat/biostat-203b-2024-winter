...
labevents_tble <- labevents_tble %>%
  rename_with(.fn = ~ifelse(.x %in% names(item_to_label), item_to_label[.x], .x), .cols = everything())
...
***Answer***
```{r, eval = TRUE}
admissions_tble <- read_csv("~/mimic/hosp/admissions.csv.gz", show_col_types = FALSE)
icustays_tble <- read_csv("~/mimic/icu/icustays.csv.gz", show_col_types = FALSE)
patients_tble <- read_csv("~/mimic/hosp/patients.csv.gz", show_col_types = FALSE)
